    ...
    <BackgroundPaths>
      <div className="leaderboard-root">
        <div className="leaderboard-header">
          ...
          >
            Hall of <span className="text-yellow-gradient">Fame</span>
          </motion.h1>
          <p className="leaderboard-subtitle">
            Celebrating the top algorithmic duelists across all seasonal tiers. Climb the ranks and immortalize your handle on the global leaderboard.
          </p>
        </div>
